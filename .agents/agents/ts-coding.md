...
model: sonnet
skills: ts-coding-standards, ts-review
...
Completion Criteria:
  ...
  - `biome check . --diagnostic-level=warn` passes without errors
...
4. `.agents/skills/ts-coding-standards/project-layout.md` - Directory structure, file naming
5. `.agents/skills/ts-coding-standards/async-patterns.md` - Promise handling, concurrent execution
...
**CRITICAL**: All output files must follow security guidelines defined in `.agents/skills/ts-coding-standards/security.md`.
